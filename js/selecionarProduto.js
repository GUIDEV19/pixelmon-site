...
vip30dias.addEventListener('click', function(){
    ...
    vip30dias.style.border = '2px solid blue'
    ...
    vip60dias.style.backgroundColor = 'rgb(121, 168, 255)'
    vip90dias.style.backgroundColor = 'rgb(121, 168, 255)'
})
...
vip60dias.addEventListener('click', function(){
    ...
    vip60dias.style.border = '2px solid blue'
    ...
    vip90dias.style.border = 'none'
    vip30dias.style.backgroundColor = 'rgb(121, 168, 255)'
    vip90dias.style.backgroundColor = 'rgb(121, 168, 255)'
...
vip90dias.addEventListener('click', function(){
    ...
    vip90dias.style.border = '2px solid blue'
